...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'username' => ['type' => 'string', 'length' => 70, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2022-04-14 00:01:50',
                'modified' => '2022-04-14 00:01:50',
            ],
        ];
        parent::init();
    }
